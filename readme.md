...
To use it, simply install the plugin, open the sidebar
button, then click the Settings menu. Enter the base URL,
API key, and model name, save the settings, and you’re done.

Contributing
-----------

If you're interested in contributing to the development of
AI Assistant Sidebar, you can do so by submitting issues or pull
requests. 